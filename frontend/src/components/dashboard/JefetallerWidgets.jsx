...
import styles from '../../css/Jefetaller-dashboard.module.css';
...
export default function JefetallerWidgets() {
  ...
  const fetchData = useCallback(async (showRefreshIndicator = false) => {
    ...
    try {
      ...
      const response = await apiClient.get('/dashboard/Jefetaller/stats/');
  ...
  const handleDownloadCSV = () => {
    ...
    link.setAttribute("download", "dashboard_Jefetaller.csv");
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <p className="text-gray-300">Cargando panel del Jefetaller...</p>
      </div>
    );
  }
  if (error) {
